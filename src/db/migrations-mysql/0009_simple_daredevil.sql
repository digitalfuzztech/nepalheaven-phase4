...
ALTER TABLE `media` ADD CONSTRAINT `media_general_settings_type_option_id_cms_other_settings_options_id_fk` FOREIGN KEY (`general_settings_type_option_id`) REFERENCES `cms_other_settings_options`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
