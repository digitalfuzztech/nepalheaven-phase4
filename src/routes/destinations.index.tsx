          ...
          () => ({
            meta: [
...

              {
                ...
                content:
                    "Destinations in Nepal | Nepal Heaven",
              },
...
function DestinationsPage() {
  ...
  const destinationTypeOptions:
      ...
      useMemo(
          () => [
            ...
            ...listingPage.destinationTypes.map(
                (
                    option,
                ) => ({
                  value:
  ...
  const results =
      useMemo(
          () => {
             ...
             */
            const selectedDestinationType =
                listingPage.destinationTypes.find(
                    (
                        option,
                    ) =>
                        option.id ===
  ...
  return (
      <>
        <PageHero
            image={
                listingPage.heroImageUrl ||
                images.destAnnapurna
            }
            eyebrow={
