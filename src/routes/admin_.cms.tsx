...
import { getCmsOverviewFn } from "@/lib/admin-overview.functions";
...
export const Route = createFileRoute("/admin_/cms")({
  loader: async () => {
    ...
    const overview = await getCmsOverviewFn();
  ...
  const modules = [
    {
      ...
      valueLabel:
        overview.generalSettings === 1 ? "configured record" : "records",
    ...
    {
      title: "Navigation",
      description: "Primary navigation and footer menu structure.",
      icon: Navigation,
...

    {
      ...
      valueLabel:
        overview.footerSettings === 1 ? "configured record" : "records",
    ...
    {
      title: "Experiences",
      description: "Experience categories and their related journeys.",
      icon: Mountain,
    ...
    {
      title: "Blog",
      description: "Articles, categories, authors and publishing.",
      icon: FileText,
...

    {
      title: "About Page",
      description:
        "Mission, vision, story, counters, team, milestones, awards and partners.",
      icon: BookOpen,
      value: 1,
      valueLabel: "page",
    ...
    {
      title: "Gallery Page",
      description: "Public Gallery hero image and introductory content.",
      icon: GalleryHorizontalEnd,
      value: 1,
      valueLabel: "page",
      to: "/admin/cms/gallery" as const,
    },
    ...
    {
      title: "Testimonials",
      description: "Traveller testimonials and featured reviews.",
      icon: Star,
...

    {
      ...
      description: "Customer and internal transactional email templates.",
      icon: Mail,
        ...
        <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-relaxed text-muted-foreground">
              Manage the content displayed across Nepal Heaven. Website design
              and application logic remain controlled by the codebase.
            </p>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
                These record counts now come directly from MariaDB. Individual
                editors will be activated progressively as each CMS module is
                built and verified.
              </p>
            </div>
          </div>
