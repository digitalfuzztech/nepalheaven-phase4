...
function GeneralSettingsPage() {
    ...
    const [form, setForm] =
        useState<CmsGeneralSettingsInput>(
            settings,
        );
    ...
    async function save(
        ...
        const parsed =
            cmsGeneralSettingsInputSchema.safeParse(
                form,
            );
        ...
        try {
            const updated =
                await updateCmsGeneralSettingsFn(
                    {
                        data: parsed.data,
                    },
                );
                ...
                <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
                    <div>
                        ...
                        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-muted-foreground">
                            Manage the canonical
                            company identity, contact
                            details, social profiles and
                            default search metadata used
                            throughout Nepal Heaven.
                        </p>
                    </div>
